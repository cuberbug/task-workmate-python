...
В качестве примера настройки будет использоваться модуль `venv`, который в большинстве случаев входит в состав пакета `python3`.

Для установки виртуального окружения в директорию `.venv`, выполните находясь в корне репозитория:
...
Для запуска потребуется настроенное и активированное виртуальное окружение с использованием параметров:
